...
import type { ExtractionRequestFiltersType } from '../../types/extraction-request';

interface ExtractionRequestFiltersProps {
  filters: ExtractionRequestFiltersType;
  filtersExpanded: boolean;
  onFilterChange: (filters: ExtractionRequestFiltersType) => void;
  onFiltersExpandedChange: (expanded: boolean) => void;
  onApplyFilters: () => void;
  onClearFilters: () => void;
}

const ExtractionRequestFilters: React.FC<ExtractionRequestFiltersProps> = ({
  filters,
  filtersExpanded,
  onFilterChange,
  ...
  const handleFilterChange = (key: keyof ExtractionRequestFiltersType, value: string | Date | null) => {
            ...
            >
              ...
              <Box>
                ...
                <TextField
                  fullWidth
                  size="small"
                  value={filters.errorText || ''}
                  onChange={(e) => handleFilterChange('errorText', e.target.value)}
...
export default ExtractionRequestFilters;